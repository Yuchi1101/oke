...
if st.session_state.halaman == 1:
    st.title("💻 Web Pengenalan Risiko dan Penanganan Senyawa Kimia Umum")
    ...
    - Tautan langsung ke informasi bahan kimia lengkap
...
# ---------------------
    ...
    st.title("📄 Informasi Risiko dan Penanganan Senyawa Kimia")
...
# ---------------------
    ...
    pg = [
        {"soal": "Fungsi informasi bahan kimia adalah...", "opsi": ["Label botol", "Panduan eksperimen", "Informasi bahan kimia", "Lembar nilai"], "jawaban": "Informasi bahan kimia"},
